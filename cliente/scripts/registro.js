...
(function() {
  ...
  // Iconos
  document.getElementById('logo-icon').innerHTML    = Icons.logoPaw;
  document.getElementById('icon-cliente').innerHTML = Icons.user;
  document.getElementById('icon-vet').innerHTML     = Icons.stethoscope;
...
function actualizarIconoTema() {
  var oscuro = localStorage.getItem('ps_dark') !== 'false';
  document.getElementById('login-theme-icon').innerHTML = oscuro ? Icons.moon : Icons.sun;
